            ...
            <div className="p-4">
                ...
                <div className="flex gap-2">
                    <Link
                        ...
                        className="flex-1 py-3 rounded-xl text-sm font-bold transition-all flex items-center justify-center bg-white text-emerald-700 border-2 border-emerald-100 shadow-sm active:scale-[0.97]"
                    >
                        View Details
                    </Link>
                    <Link
