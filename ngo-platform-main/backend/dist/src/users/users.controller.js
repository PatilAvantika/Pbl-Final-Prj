...
const password_validation_1 = require("../auth/password.validation");
...
__decorate([
    ...
    (0, class_validator_1.MinLength)(password_validation_1.PASSWORD_MIN_LENGTH),
    (0, class_validator_1.Matches)(password_validation_1.PASSWORD_REGEX, { message: password_validation_1.PASSWORD_RULE_MESSAGE }),
    __metadata("design:type", String)
