...
exports.AttendanceIntroDto = exports.FaceSamplesDto = exports.FaceSampleItemDto = exports.OnboardingProfileDto = void 0;
...
class AttendanceIntroDto {
    faceSnapshot;
}
exports.AttendanceIntroDto = AttendanceIntroDto;
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(12_000_000),
    (0, class_validator_1.Matches)(/^data:image\/jpeg;base64,/, { message: 'faceSnapshot must be a JPEG data URL' }),
    __metadata("design:type", String)
], AttendanceIntroDto.prototype, "faceSnapshot", void 0);
