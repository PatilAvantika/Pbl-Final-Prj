...
let TasksController = class TasksController {
    ...
    constructor(tasksService, auditService, decisionIntelligence) {
    ...
    async taskSuggestions(taskId, req) {
        const organizationId = requireOrganizationId(req);
...
__decorate([
    ...
    (0, common_1.Get)('suggestions/:task_id'),
    __param(0, (0, common_1.Param)('task_id')),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], TasksController.prototype, "taskSuggestions", null);
__decorate([
    (0, common_1.Get)(':id'),
